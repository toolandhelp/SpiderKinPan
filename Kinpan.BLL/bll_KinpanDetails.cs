...
{
    public class bll_KinpanDetails
    {
        #region dbContext
        public DbHelperEfSql<t_KinpanDetails> dbContext { get; set; }
        public bll_KinpanDetails()
        {
            dbContext = new DbHelperEfSql<t_KinpanDetails>();
        }
        #endregion
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public t_KinpanDetails GetObjectById(int orgId)
        {
        ...
        /// <returns></returns>
        public IList<t_KinpanDetails> GetListByCondition(ConditionModel conditionItem)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IList<t_KinpanDetails> GetListByAll()
        {
        ...
        /// <returns></returns>
        public IList<t_KinpanDetails> GetListByCondition(int[] orgIds)
        {
